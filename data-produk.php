				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<button><a href="edit-produk.php?id=<?php echo $row['product_id'] ?>">Edit</a> </button>
								<button><a href="proses-hapus.php?id=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a></button>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
